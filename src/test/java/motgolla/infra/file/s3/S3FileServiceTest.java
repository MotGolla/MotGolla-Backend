...
class S3FileServiceTest {
  ...
  void upload_success() throws Exception {
    ...
    InputStream imageStream = getClass().getResourceAsStream("/static/test-clothing-image.jpg");
    MockMultipartFile file = new MockMultipartFile(
        "file",
        "test-clothing-image.jpg",
        "image/jpeg",
        imageStream
    );
  ...
  void delete_success() throws Exception {
    ...
    InputStream imageStream = getClass().getResourceAsStream("/static/test-clothing-image.jpg");
    MockMultipartFile file = new MockMultipartFile(
        "file", "test-clothing-image.jpg", "image/jpeg", imageStream
    );
